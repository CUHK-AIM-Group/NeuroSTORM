#!/bin/bash
# bash scripts/adhd200_downstream/ft_fmrifound_task3.sh batch_size
...
project_name="cobre_ft_fmrifound_task3_dx_train1.0"
...
python main.py \
  ...
  --clf_head_version v1 \
  --dataset_name Cobre \
  --image_path ./data/COBRE_MNI_to_TRs_minmax \
