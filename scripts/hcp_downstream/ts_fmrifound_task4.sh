#!/bin/bash
# Test/transfer on HCP1200 for re-identification (classification)
# bash scripts/hcp_downstream/ts_fmrifound_task4.sh [batch_size]
...
project_name="hcp_ts_fmrifound_task4_reid_train1.0"
